...
def autenticar_service_account():
    ...
    try:
        ...
        try:
            # Primeiro tenta listar arquivos da pasta específica no drive compartilhado
...
def upload_para_google_drive(caminho_arquivo, nome_arquivo, service, folder_id=None):
    """Upload com suporte a drives compartilhados - CORRIGIDO para Service Account"""
    try:
        ...
        # Parâmetros para todas as chamadas - CRÍTICO para Service Account
        drive_params = {
            'supportsAllDrives': True
        }
        
        # Para Service Account no Streamlit Cloud, precisamos especificar o driveId
        if is_streamlit_cloud():
            drive_params['driveId'] = SHARED_DRIVE_ID
        
        # Verifica se arquivo já existe - usando a query correta para drive compartilhado
        ...
        # Se estiver no Streamlit Cloud, especifica o corpora como 'drive' e adiciona driveId
        if is_streamlit_cloud():
        ...
        # Para upload em drive compartilhado com Service Account, precisamos do enforceSingleParent=True
        upload_params = {
            'body': file_metadata,
        ...
        # Se for Service Account, adiciona parâmetros específicos para drive compartilhado
        if is_streamlit_cloud():
