# app.py - Relatório de Fiscalização - Versão para Streamlit Cloud
        ...
        if hasattr(st, "secrets"):
            ...
            if google_creds:
                ...
                try:
                    ...
                    st.warning(f"Erro ao autenticar com Service Account: {e}")
...
class PDF(FPDF):
    ...
    def header(self):
        ...
        if self.logo_data:
            try:
                # Tentar carregar logo de base64 ou URL
                if isinstance(self.logo_data, str) and self.logo_data.startswith('data:image'):
                    ...
                    if 'base64,' in self.logo_data:
                        ...
                        self.ln(15)
                elif isinstance(self.logo_data, str) and self.logo_data.endswith(('.png', '.jpg', '.jpeg')):
                    # Logo de arquivo local (apenas desenvolvimento)
...
def obter_logo():
    ...
    # Usar placeholder base64
    placeholder_base64 = """
    iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAABw4pVUAAAACXBIWXMAAAsTAAALEwEAmpwYAAAA
    AXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAABFSURBVHgB7dMxEQAgDAAxhH8PZ7CQ8CYYmM2e
    T+4AAAAAAAAAAAAAAAAAAAAAAABw0AF3zQABy1X+gQAAAABJRU5ErkJggg==
    """
    return f"data:image/png;base64,{placeholder_base64.strip()}"
            ...
            if total_fotos == 0:
                ...
                with col_foto:
                    try:
                        ...
                        st.image(img, 
                                caption=f"Foto {current_foto_idx + 1} - Preview",
                                use_container_width=True)
                    except Exception as e:
        ...
        with col_gerar1:
            if st.button("📄 GERAR RELATÓRIO PDF", 
                ...
                try:
                    ...
                    elif upload_drive and not GOOGLE_DRIVE_FOLDER_ID:
                        st.warning("⚠️ ID da pasta do Google Drive não configurado.")
