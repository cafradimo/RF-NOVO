...
def upload_para_google_drive(caminho_arquivo, nome_arquivo, service, folder_id=None):
    ...
    try:
        ...
        # Parâmetros comuns para todas as chamadas - SEM driveId aqui
        drive_params = {
            'supportsAllDrives': True
        }
        ...
        # Para listagem, podemos incluir driveId se necessário
        list_params = {
            'q': query,
            'spaces': 'drive',
        ...
        # Adiciona corpora e driveId apenas se for Streamlit Cloud
        if is_streamlit_cloud():
        ...
        if arquivos:
            ...
            # Para atualização, usa apenas supportsAllDrives
            file = service.files().update(
                fileId=file_id,
                body=file_metadata,
                media_body=media,
                fields='id, name, webViewLink, webContentLink, size, modifiedTime',
                supportsAllDrives=True  # Apenas este parâmetro
            ).execute()
